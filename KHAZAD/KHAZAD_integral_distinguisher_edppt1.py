...
if __name__ == "__main__":
    ...
    cd["cipher_name"] = "KHAZAD"

    cd["cipher_size"] = 64

    cd["inequalities"] = KHAZAD.KHAZAD_specify.inequalities_EDPPT1
    ...
    for weight in range(1, 8):
        ...
        for b in get_b_search_space(weight):
            ...
            for e in e_search_space:
                ...
                KHAZAD.KHAZAD_model.model(cd)
                flag = KHAZAD.KHAZAD_model.model_solve(cd["solve_file"])
                if flag:
                    bll = e_dict[str(e)]
