...
import copy
import SMS4.SMS4_specify
import time
import os
import SMS4.SMS4_model
...
if __name__ == "__main__":
    ...
    cd["inequalities"] = SMS4.SMS4_specify.inequalities_EDPPT
    ...
    for weight in range(5, 6):
        ...
        for b in get_b_search_space(weight):
            ...
            for e in e_search_space:
                ...
                SMS4.SMS4_model.model(cd)
                flag = SMS4.SMS4_model.model_solve(cd["solve_file"])
                if flag:
                    bll = e_dict[str(e)]
            ...
            if distinguish_find1:
                ...
                rf.write("*" * 20)
                rf.write("{}th  12round integral distinguish (weight = {}) based on division property"
